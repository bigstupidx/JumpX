...
public class selectManager : MonoBehaviour {
    ...
    void selectInit()
    {
        ...
        shopBtn = allBtnPanel.transform.Find("shopBtn").GetComponent<Button>();
        MyBtn = allBtnPanel.transform.Find("MyBtn").GetComponent<Button>();
        rangkingBtn = allBtnPanel.transform.Find("rangkingBtn").GetComponent<Button>();
        tropyBtn = allBtnPanel.transform.Find("tropyBtn").GetComponent<Button>();
        setupBtn = allBtnPanel.transform.Find("setupBtn").GetComponent<Button>();

        storeAndRoom = UiCanvas.gameObject.transform.Find("StoreAndRoom").gameObject;
        ui_back_large = storeAndRoom.gameObject.transform.Find("ui_back_large").gameObject;
        storeAndRoom.SetActive(false);


        //설정
        setup = UiCanvas.gameObject.transform.Find("setup").gameObject;
        setupExit = setup.transform.Find("setupExit").GetComponent<Button>();
        setupExit.onClick.AddListener(setupExitBtnFunc);
        setup.SetActive(false);

        //골드 보석 상점
        goldBosuk = UiCanvas.gameObject.transform.Find("goldBosuk").gameObject;
        goldStore = goldBosuk.transform.Find("goldStore").gameObject;
        bosukStore = goldBosuk.transform.Find("bosukStore").gameObject;


        bosukRealBtn = allBtnPanel.transform.Find("bosukBtn").GetComponent<Button>();
        bosukRealBtn.onClick.AddListener(bosukRealBtnFunc);
        goldRealBtn = allBtnPanel.transform.Find("goldBtn").GetComponent<Button>();
        goldRealBtn.onClick.AddListener(goldRealBtnFunc);
        bosukBtn = goldBosuk.transform.Find("bosukBtn").GetComponent<Button>();
        bosukBtn.onClick.AddListener(bosukBtnFunc);
        goldBtn = goldBosuk.transform.Find("goldBtn").GetComponent<Button>();
        goldBtn.onClick.AddListener(goldBtnFunc);
        goldbosukExitBtn = goldBosuk.transform.Find("goldbosukExitBtn").GetComponent<Button>();
        goldbosukExitBtn.onClick.AddListener(goldbosukExitBtnFunc);

        bosuk1000won = bosukStore.transform.Find("1000won").GetComponent<Button>();
        bosuk1000won.onClick.AddListener(() => bosukBuy(1000));
        bosuk2500won = bosukStore.transform.Find("2500won").GetComponent<Button>();
        bosuk2500won.onClick.AddListener(() => bosukBuy(2500));
        bosuk32500won = bosukStore.transform.Find("32500won").GetComponent<Button>();
        ...
        myRoom = ui_back_large.transform.Find("MyRoom").gameObject;
        cha_selectUi = myRoom.transform.Find("cha_selectUi").gameObject;
        empty_panel = cha_selectUi.transform.GetChild(0).gameObject;
        cha_scrollpanel = empty_panel.transform.GetChild(0).gameObject;
        cha_btnAll = cha_scrollpanel.transform.Find("cha_btnAll").gameObject;
        ...
        store = ui_back_large.transform.Find("Store").gameObject;

        greenBoxBtn = store.transform.Find("greenBoxBtn").GetComponent<Button>();
        greenBoxBtn.onClick.AddListener(greenBoxBtnFunc);
        redBoxBtn = store.transform.Find("redBoxBtn").GetComponent<Button>();
        redBoxBtn.onClick.AddListener(redBoxBtnFunc);
        blueBoxBtn = store.transform.Find("blueBoxBtn").GetComponent<Button>();
        blueBoxBtn.onClick.AddListener(blueBoxBtnFunc);

        storeRoomExit = ui_back_large.transform.Find("StoreRoomExit").GetComponent<Button>();
        storeRoomExit.onClick.AddListener(storeRoomExitFunc);

        myRoomBtn = ui_back_large.transform.Find("myRoomBtn").GetComponent<Button>();
        myRoomBtn.onClick.AddListener(MyBtnFunc);
        storeBtn = ui_back_large.transform.Find("storeBtn").GetComponent<Button>();
